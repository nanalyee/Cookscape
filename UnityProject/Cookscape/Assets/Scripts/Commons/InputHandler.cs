...
namespace UnityProject.Cookscape
{
    public class InputHandler : MonoBehaviour
    {
        ...
        private bool tmp_ExitMenuOn = false;
        public bool m_IsEventSystemOn = false;
        public void GetESCInputDown()
        {
            if (Input.GetKeyDown(KeyCode.Escape))
            {
                ...
                if (m_IsEventSystemOn) {
                    if (tmp_ExitMenuOn) {
                        GameManager.instance.TmpHideExitMenu();
                    } else {
                        GameManager.instance.TmpShowExitMenu();
                    }
                    tmp_ExitMenuOn = !tmp_ExitMenuOn;
                }
            }
        }
    }
